<?php
    if (Auth::user() == "") {
        ...
        $settings = App\SmUnitLevelSetting::find(1);
...
<nav id="sidebar">
    ...
    @if(Auth::user()->role_id != 2 && Auth::user()->role_id != 3 && Auth::user()->role_id != 10 )
        ...
        <li>
            <a href="{{url('/agenda')}}" id="admin-agenda">
                <span class="flaticon-speedometer"></span>
                AGENDA
            </a>
        </li>
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="subMenuAdmin">
                ...
                <li>
                    ...
                    <a href="{{route('school-attendance')}}">Atendimentos</a>
                </li>
                @endif
                @if(@in_array(27, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{url('postal')}}">ENTREGAS E DESPACHOS</a>
                </li>
                <!-- <li>
                ...
                <li>
                    <a href="{{route('generate_id_card')}}">EMISSÃO ID DE ALUNO</a>
                </li>
                @endif
                @if(@in_array(53, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{route('generate_certificate')}}">EMISSÃO DE CERTIFICADOS</a>
                </li>
                @endif
                ...
                <li>
                    <a href="{{url('setup-admin')}}">CONFIGURAÇÃO ATENDIMENTO</a>
                </li>
                @endif
                @if(@in_array(45, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{url('student-id-card')}}">CONFIGURAÇÃO ID DE ALUNO</a>
                </li>
                @endif
                @if(@in_array(49, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{url('student-certificate')}}">CONFIGURAÇÃO DE CERTIFICADOS</a>
                </li>
                @endif
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="subMenuCommunicate">
                ...
                <li>
                    <a href="#">ESTÚDIO DE CRIAÇÃO DE E-MAILS</a>
                </li>
                @endif
                {{--
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="subMenuStudent">
                ...
                <li>
                    <a href="{{route('student_list')}}">LISTA DE ALUNOS</a>
                </li>
                <li>
                    <a href="{{route('responsibles')}}">RESPONSÁVEIS</a>
                </li> 
                @endif
                ...
                <li>
                    <a href="{{route('student_category')}}">Características de alunos</a>
                </li>
                @endif
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="subMenuAcademic">
            	<li>
                    <a href="{{url('classes')}}">Turmas</a>
                </li>
                <li>
                    <a href="{{url('lesson-notes')}}">Apontamento de aulas</a>
                </li>
                <li>
                    <a href="{{url('year-phase-course')}}">Ano / Fase / Curso</a>
                </li>
                <li>
                    <a href="{{url('steps')}}">ETAPAS</a>
                </li>
                @if(@in_array(269, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{url('class-room')}}">LOCAL DE AULA</a>
                </li>
                @endif
                <li>
                    <a href="{{url('class-schedule')}}">Plano de ensino e aulas</a>
                </li>
                ...
                <li>
                    <a href="{{route('student_attendance_report')}}">RELATÓRIO DE FREQUENCIA</a>
                </li>
                @endif

				@if(@in_array(81, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{route('student_promote')}}">APROVAÇÃO DE ANO/FASE/CURSO</a>
                </li>
                @endif
	    ...
	    <li>
	        ...
	        <ul class="collapse list-unstyled" id="subMenulibrary">
	            ...
	            <li>
	                <a href="{{url('member-list')}}"> RETIRADAS E DEVOLUÇÕES</a>
	            </li>
	            @endif
	            @if(@in_array(301, $module_links) || Auth::user()->role_id == 1)
	            <li>
	                <a href="{{url('book-list')}}"> ACERVO DA BIBLIOTECA</a>
	            </li>
	            @endif
	            @if(@in_array(314, $module_links) || Auth::user()->role_id == 1)
	            <li>
	                <a href="{{url('all-issed-book')}}">CONTROLE DE RETIRADA E DEVOLUÇÃO</a>
	            </li>
	            @endif
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="subMenuExam">
                ...
                <li>
                    <a href="{{route('marks_register')}}">REGISTRO DE NOTAS</a>
                </li>
                @endif
                ...
                <li>
                    <a href="{{route('send_marks_by_sms')}}">ENVIAR NOTAS POR SMS</a>
                </li>
                @endif
                ...
                <li>
                    <a href="{{url('online-exam')}}">EXAME ON-LINE</a>
                </li>
                @endif
            </ul>
        </li>
        ...
        <li>
            <a href="#subMenuFinance" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                <span class="fa fa-money ml-20"></span>
                Financeiro
            </a>

            <ul class="collapse list-unstyled" id="subMenuFinance">

                @if(@in_array(398, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{url('finance')}}">Controle Financeiro</a>
                </li>
                @endif
                @if(@in_array(88, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{url('finance_title_menu')}}">CRIAR TÍTULOS</a>
                </li>
                @endif

                @if(@in_array(100, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{url('finance_group_menu')}}">CADASTRO DE CATEGORIAS</a>
                </li>
                @endif

                @if(@in_array(96, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{url('finance_discount_menu')}}">CADASTRO DE DESCONTOS</a>
                </li>
                @endif

                <!-- @if(@in_array(105, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{url('other-download-list')}}">PARÂMETROS BANCO SCHOOLING</a>
                </li>
                @endif -->
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="subMenuHumanResource">
            	<li>
                    <a href="{{route('staff_directory_new')}}">COLABORADORES</a>
                </li>
                ...
                <li>
                    <a href="{{url('designation')}}">GRUPOS DE ACESSO</a>
                </li>
                @endif
                @if(@in_array(184, $module_links) || Auth::user()->role_id == 1)
                <li>
                    <a href="{{url('department')}}">DEPARTAMENTOS</a>
                </li>
                @endif
                <li>
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="subMenuLeaveManagement">
                ...
                <li>
                    <a href="{{url('leave-type')}}">TIPOS DE LICENÇA</a>
                </li>
                @endif
            </ul>
        </li>
	    ...
	    <li>
	        ...
	        <ul class="collapse list-unstyled" id="subMenusystemReports">
	            ...
	            <li>
	                <a href="{{route('student_report')}}">RELATÓRIO DE ALUNO</a>
	            </li>
	            @endif
	            ...
	            <li>
	                <a href="{{route('student_history')}}">HISTÓRICO DE ALUNO</a>
	            </li>
	            @endif
	            ...
	            <li>
	                <a href="{{route('online_exam_report')}}">RELATÓRIO DE EXAME ON-LINE</a>
	            </li>
	            @endif
	    ...
	    <li>
            <a href="{{url('/store')}}" id="admin-store">
                <span class="flaticon-inventory"></span>
                ALMOXARIFADO
            </a>
        </li>
	    ...
	    <li>
	        ...
	        <ul class="collapse list-unstyled" id="subMenufrontEndSettings">
	            <li>
	                <a href="{{url('admin-home-page')}}"> SITE </a>
	            </li>

	            <li>
	                <a href="{{url('news')}}">CONTEÚDOS</a>
	            </li>
	            <li>
	                <a href="{{url('news-category')}}">@lang('lang.category')</a>
	            </li>
	            <li>
	                <a href="{{url('testimonial')}}">DEPOIMENTOS</a>
	            </li>
	            <li>
	            ...
	            <li>
	                <a href="{{url('contact-message')}}">MENSAGENS DE CONTATO</a>
	            </li>
	            <li>
	                <a href="{{url('about-page')}}">SOBRE NÓS </a>
	            </li>
	            <li>
	                <a href="{{url('custom-links')}}"> LINKS CUSTOMIZADOS </a>
	            </li>
	        </ul>
	    </li>
	    @endif
	    ...
	    <li>
	        ...
	        <ul class="collapse list-unstyled" id="subMenusystemSettings">
	            ...
	            @endif
	            <li>
	                <a href="{{url('unit-level-settings')}}"> Unidades/Níveis </a>
	            </li>
	            ...
	            <li>
	                <a href="{{route('role')}}">GRUPOS DE ACESSO</a>
	            </li>
	            @endif
	            ...
	            @if(@in_array(120, $module_links) || Auth::user()->role_id == 1)
	            <li>
	                <a href="{{url('login-access-control')}}">PERMISSÃO DE LOGIN</a>
	            </li>
	            @endif

	            @if(@in_array(121, $module_links) || Auth::user()->role_id == 1)
	            {{--                            
	            	<li> <a href="{{route('base_group')}}">@lang('lang.base_group')</a>
	    			</li>
	    		--}}
	    		@endif
			    ...
			    <li>
			        <a href="{{url('language-settings')}}">CONFIGURAÇÕES DE IDIOMA</a>
			    </li>
			    @endif
			    @if(@in_array(129, $module_links) || Auth::user()->role_id == 1)
			    <li>
			        <a href="{{url('backup-settings')}}">CÓPIA DE SEGURANÇA</a>
			    </li>
			    @endif

			    @if(@in_array(130, $module_links) || Auth::user()->role_id == 1)
			    <li>
			        <a href="{{url('update-system')}}">ATUALIZAÇÃO DO SISTEMA</a>
			    </li>
			    @endif

			    @if(Auth::user()->role_id == 1)
			    <li>
			        <a href="{{url('admin-data-delete')}}">PRÉ-CONFIGURAÇÕES</a>
			    </li>
			    @endif
	    	</ul>
	    </li>
	    ...
	    <li>
	        ...
	        <ul class="collapse list-unstyled" id="subMenusystemStyle">
	            @if(in_array(117, $module_links) || Auth::user()->role_id == 1)
	            <li>
	                <a href="{{url('background-setting')}}">CONFIGURAÇÕES DE FUNDO</a>
	            </li>
	            <li>
	                <a href="{{url('color-style')}}">ESTILOS DE COR</a>
	            </li>
	            @endif
	        </ul>
	    </li>
	    ...
	    @if(in_array(18, $modules) || Auth::user()->role_id == 1)
	    <li>
	        <a href="#subMenuApi" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
	            <span class="flaticon-settings"></span>
	            PERMISSÕES DE API
	        </a>
	        <ul class="collapse list-unstyled" id="subMenuApi">
	            @if(in_array(117, $module_links) || Auth::user()->role_id == 1)
	            <li>
	                <a href="{{url('api/permission')}}">PERMISSÕES DE API</a>
	            </li>
	            @endif
	        </ul>
	    </li>
