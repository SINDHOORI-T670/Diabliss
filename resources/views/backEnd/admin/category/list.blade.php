                    ...
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn mr-2 mb-2 btn-danger" onclick="location.href='{{ url('admin/delete/category')}}/{{$item->id}}'">
                                    Delete
                                </button>
                                <a class="btn mr-2 mb-2 btn-warning text-white" href="{{url('admin/list/sub-category')}}/{{$item->id}}">Sub Category</a>
                            </td>
                        </tr>
                        <div class="modal fade" id="editCategory{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  aria-modal="true" style="top:90px;">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="{{ url('admin/update/category') }}/{{$item->id}}">
                                        @csrf
