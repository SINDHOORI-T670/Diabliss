...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/pages-login-boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jan 2022 05:02:52 GMT -->
...
<head>
    ...
    <title>Admin Login - Diabliss</title>
    <meta name="viewport"
        content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, shrink-to-fit=no" />
    <meta name="description" content="Admin Login - Diabliss">
            ...
            <div class="h-100 bg-plum-plate bg-animation">
                <div class="d-flex h-100 justify-content-center align-items-center">
                    <div class="mx-auto app-login-box col-md-8">
                            ...
                            <div class="modal-content">
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <h6 class="mb-0">No account? <a href="{{ url('/register') }}" class="text-primary">Sign up now</a></h6>
                                    </div>
                        ...
                        <div class="text-center text-white opacity-8 mt-3">Copyright © Diabliss 2022 </div>
                    </div>
                </div>
            </div>
        </div>
